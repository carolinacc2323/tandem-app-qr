...
const Footer = () =>{
    return(
        <footer>
            ...
            <div className={footerStyle.logoblanco}>
                <StaticImage  src="../images/logoblanco.png" alt="logo blanco" className='logoblanco'/>
            </div>
            <div className={footerStyle.logotipos}>
                <div className={footerStyle.RRSS}>
                ...
                <div className={footerStyle.enlaces}>
                ...
                <div className={footerStyle.footerbottom}>
                    <StaticImage src="../images/sepe.png"/>
                </div>
        </div>
        </footer>
