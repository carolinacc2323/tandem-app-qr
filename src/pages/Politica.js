...
const Politica =()=>{
    return(
        <Layout>
            ...
            <h2 className="h2pages">RESPONSABLE DE LOS DATOS</h2>
            <p>Identidad: Consejo de Administración del Patrimonio Nacional.</p>
            <p>NIF: S2801002C</p>
            <p>Dirección postal: Palacio Real. Calle Bailén s/n - 28071- Madrid</p>
            <p>Teléfono: 34 914 548 700</p>
            <p>Ejercicio de derechos de afectados: dpd@mpr.es o en la dirección https://sedempr.gob.es/es/proteccion_de_datos</p>
            <p>Contacto Delegado Protección de Datos: dpd@mpr.es</p>
            <h2 className="h2pages">CONSERVACIÓN</h2>
            ...
            <h2 className="h2pages">DERECHOS</h2>
            ...
            <p>Puede ejercitar sus derechos de acceso, rectificación, supresión y portabilidad de sus datos, de limitación y oposición a su tratamiento, así como a no ser objeto de decisiones basadas únicamente en el tratamiento automatizado de sus datos, cuando procedan, a través de https://sedempr.gob.es/es/proteccion_de_datos o en la dirección de correo electrónico dpd@mpr.es.</p>
            ...
            <h2 className="h2pages">LEGITIMACIÓN</h2>
            ...
            <h2 className="h2pages">DESTINATARIOS</h2>
            ...
            <h2 className="h2pages">PROCEDENCIA DE LOS DATOS</h2>
            ...
            <h2 className="h2pages">SEGURIDAD</h2>
