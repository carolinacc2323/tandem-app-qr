...
function InfoInstitucional(props) {
  ...
  return (
    ...
    <div className='container'>
        ...
        <h1 className="h1pages">SOBRE PATRIMONIO NACIONAL</h1>
      <Accordion flush open={open} toggle={toggle}>
        <AccordionItem>
          <AccordionHeader targetId="1" className="tituloaccordion">Bienvenida de la Presidenta</AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="2" className="tituloaccordion">Conoce nuestra historia</AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="3" className="tituloaccordion">Consejo de Administración</AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="4" className="tituloaccordion">Actos oficiales e institucionales</AccordionHeader>
          ...
          <p style={{
            ...
            fontSize:'30px',
            fontFamily: 'Georgia, serif'
          }}>ACTOS OFICIALES E INTITUCIONALES</p>
            <p  style={{
              fontSize:'16px',
              fontFamily: 'Georgia, serif',
              textAlign: 'justify'
            ...
            <p style={{
              ...
              fontFamily: 'Georgia, serif',
              color: '#B41400'
            }}>Dirección de Actos Oficiales y Culturales</p>
            <p style={{
              fontSize:'16px',
              fontFamily: 'Georgia, serif',
              color: '#B41400'
        ...
        <AccordionItem>
          <AccordionHeader targetId="5" className="tituloaccordion"><a href="https://www.casareal.es/ES/Paginas/home.aspx">Casa de S.M el Rey</a></AccordionHeader>
          <AccordionBody accordionId="5">

          </AccordionBody>
        </AccordionItem>
        <AccordionItem>
          <AccordionHeader targetId="6" className="tituloaccordion"><a href='https://www.patrimonionacional.es/sobre-patrimonio/retratos-ssmm'>
            Retratos oficiales</a></AccordionHeader>

        </AccordionItem>
        <AccordionItem>
          <AccordionHeader targetId="7" className="tituloaccordion"><a href='https://www.mpr.gob.es/Paginas/index.aspx'>
